      ...
      <CardContent className="space-y-2">
        ...
        <div className="flex gap-1.5">
          ...
          <Button
            ...
            size="sm"
            className="shrink-0 bg-emerald-600 hover:bg-emerald-700 text-white h-9 w-9 p-0"
          >
        ...
        {speakers.length > 0 ? (
          <div className="space-y-0.5">
                ...
                <AnimatePresence mode="popLayout">
                  {speakers.map((speaker, index) => (
                    <motion.div
                      ...
                      className={`flex items-center gap-1.5 px-2 py-1.5 rounded-lg transition-colors cursor-pointer group ${
                    ...
                    >
                      ...
                      {index === currentSpeakerIndex && (
                        <Badge variant="default" className="bg-emerald-500 text-[9px] px-1 py-0 h-4">
                          Falando
                        </Badge>
                      )}
                      ...
                      <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                        ...
                        <button
                          ...
                          className="text-muted-foreground hover:text-destructive p-0.5 leading-none"
                        >
                          <X className="h-3 w-3" />
                        </button>
                      </div>
            ...
            {currentSpeakerIndex < speakers.length - 1 && currentSpeakerIndex >= 0 && (
              <Button
                ...
                variant="outline"
                size="sm"
                className="w-full mt-1 border-emerald-300 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 h-8 text-xs"
              >
            ...
            {currentSpeakerIndex === -1 && speakers.length > 0 && (
              <Button
                ...
                size="sm"
                className="w-full mt-1 bg-emerald-600 hover:bg-emerald-700 text-white h-8 text-xs"
              >
                <SkipForward className="h-3 w-3 mr-1" />
          ...
          <div className="text-center py-4 text-muted-foreground">
            ...
            <p className="text-xs">Adicione participantes à fila</p>
          </div>
        )}
      </CardContent>
    </Card>
